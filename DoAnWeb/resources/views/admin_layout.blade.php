    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{asset('backend/images/vi.png')}}">
                <span class="username">
                    <?php
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{URL::to('/list-category-product')}}">Danh sách loại sản phẩm</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/view-order')}}">Danh sách đơn hàng</a></li>
